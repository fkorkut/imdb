...
<li><a class="rss" href="#"></a></li><li><a class="facebook" href="https://www.facebook.com/pages/NFS/231342387036317?ref=hl"></a></li><li><a class="twitter" href="#"></a></li><li><a class="pinterest" href="#"></a></li><li><a class="dribbble" href="#"></a></li><li><a class="flickr" href="#"></a></li><li><a class="linkedin" href="#"></a></li></ul><!-- End Intro --> 
	...
	<div class="main-image">
		<div class="outer">
			<span class="inset"><img src="style/images/art/r2.jpg"  width=1100 height=300 alt="" /></span>
		</div>
	</div>
	<!-- End Main Image --> 
...
$db->set_charset("utf8");
$sorgu = $db->prepare('select * from film F 
									...
									inner join vizyondakifilmler V on V.vizyonID=F.vizyonID
									where V.vizyonID=1');
$sorgu->execute();
...
while ($veri = $sonuc->fetch_assoc()){
	echo '
		...
		<div class="one-third">
		<br><br><br>
			<div class="outer none"><span ><img src='.$veri['resimUrl'].'  </span></div>
		</div>
...
$sorgu1 = $db->prepare('select * from film F 
									inner join vizyondakifilmler V on V.vizyonID=F.vizyonID
									inner join gosterim GS on GS.filmID=F.filmID
									 inner join sinemalar SM on SM.sinemaID=GS.sinemaID
									where V.vizyonID=1');
$sorgu1->execute();
								
$sonuc1 = $sorgu1->get_result();
$sayi1 = $sonuc1->num_rows;
echo '<h1 class="title">Gösterimdeki sinemalar</h1>';
while ($veri1 = $sonuc1->fetch_assoc()){
	echo '
...
<div class="box">
	...
	<div class="one-half">
		...
		<div class="info-box">Şehir: '.$veri1['il'].' </div>
		<div class="note-box">Sinema Adi : '.$veri1['sinemaAd'].'</div>
		<div class="warning-box">Gösterim Tarihi: '.$veri1['Tarih'].' </div>
