...
$db->set_charset("utf8");
$sorgu = $db->prepare('select * from  filmoyunculari O
									inner join film F on F.filmID=O.filmID
									 inner join  oyuncubilgileri OB on OB.OyuncuID=O.OyuncuID
									 inner join oyuncudetaylari OD on OD.oyuncuDetayID=O.oyuncuDetayID
									');
...
<div class="box">
	...
	<h1 class="title">Oyuncular</h1>
	<div class="one-third">
		<br><br><br>
			<div class="outer none"><span ><img src='.$veri['oyuncuResimUrl'].'  </span></div>
		</div>
	
	<div class="one-half">
	
		<div class="info-box">Adı: '.$veri['oyuncuAd'].' '.$veri['oyuncuSoyad'].'</div>
		<div class="download-box">Uyruğu : '.$veri['oyuncuUyruk'].'</div>
		<div class="warning-box">Doğum Tarihi : '.$veri['dogumTarihi'].' </div>
		<div class="note-box">Biyografisi : '.$veri['biyografi'].'</div>
		<div class="download-box">Oynadığı Film Adı : '.$veri['filmAdi'].'</div>
	</div>
